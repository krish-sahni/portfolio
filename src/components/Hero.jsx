      ...
      >
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            Firmware engineer at Apple.<br className='sm:block hidden' />
            I work at the hardware-software boundary —<br className='sm:block hidden' />
            bare-metal C, embedded systems,<br className='sm:block hidden' />
            silicon bring-up.
          </p>
